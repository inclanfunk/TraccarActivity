...
public class TraccarService extends Service {
    ...
    //Flag set by the UI to indicate whether the location should be reporte with danger or not.
    ...
    private PositionProvider.PositionListener positionListener = new PositionProvider.PositionListener() {
        ...
        public void onPositionUpdate(Location location) {
            if (location != null) {
                ...
                clientController.setNewLocation(Protocol.createLocationMessage(extended, location,inDanger, getBatteryLevel()));
            }
        }
